exports.config = {
  ...
  before: function () {
    ...
    console.log("Environment varijable su uspješno učitane.");
  },
  specs: ["./test/specs/**/*.js"],
  // Patterns to exclude.
  exclude: [
  ...
  capabilities: [{
    browserName: 'chrome',
    'goog:chromeOptions': {
        args: ['--start-maximized']  // Ovo može pomoći da se test izvodi u normalnom režimu sa grafičkim interfejsom
    }
}],
