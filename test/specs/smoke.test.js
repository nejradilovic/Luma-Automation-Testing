const { HomePage, LoginPage, ProductPage, ShippingPage, PaymentsPage, SuccessPage } = require('../pageobjects/pageObjects');
...
describe('Smoke Test - Product Purchase Flow', () => {
    ...
    it('should input shipping details and complete the purchase', async () => {
        ...
        const confirmationMessage = await SuccessPage.spanThankYouMeassage.getText();
